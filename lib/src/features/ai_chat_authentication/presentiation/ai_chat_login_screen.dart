...
class AiChatLoginScreen extends ConsumerWidget {
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                AiChatSignUpPrompt(
                  promptText: context.loc.dontHaveAnAccount,
                  signUpOrLogin: context.loc.signUp,
                  onTap: () => context.goNamed(AiChatRoute.signUp.name),
                ),
